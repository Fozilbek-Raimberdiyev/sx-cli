...
*/ \n \n` +
    ...
    fs.writeFile(routePath, updatedData, 'utf8', (err) => {
        if (err) {
            console.error('Faylni yaratishda xato:', err)
            return
        }
